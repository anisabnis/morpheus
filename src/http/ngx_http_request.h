...
typedef struct {
    ...
    ngx_array_t                       *alternate_objects;
    ngx_array_t                       *alternate_resolutions;
    ngx_array_t                       *alternate_scores;
    ngx_array_t                       *resolvable_objects;
    ngx_array_t                       *resolvable_resolutions;
    ngx_array_t                       *resolvable_scores;
    ngx_array_t                       *superresolution_models;
    ngx_str_t                         resolution;
...
struct ngx_http_request_s {
    ...
    ngx_uint_t                        gpu_usage;
    ngx_uint_t                        mem_usage;
    ngx_uint_t                        superresolution_time;
    ngx_uint_t                        best_quality_to_download;
    ngx_uint_t                        resolvable_from_origin;
    ngx_int_t                        alternate_to_download_index;
    ngx_int_t                        resolvable_to_alternate_index;
    ngx_int_t                        resolve_to_quality;
    ngx_int_t                         expected_request_processing_time;
    ngx_int_t                         expected_request_processing_time_1;
    ngx_int_t                         expected_request_processing_time_2;
    ngx_int_t                         bandwidth_cost;
    ...
    unsigned                          subrequestdone:1;
    unsigned                          subsubrequestdone:1;
